...
internal sealed record ApiHeight([property: JsonPropertyName("meters")] string? Meters);
internal sealed record ApiWeight([property: JsonPropertyName("kilograms")] string? Kilograms);
...
internal sealed record ApiStatsPlayer([property: JsonPropertyName("id")] int Id);
internal sealed record ApiStatsTeam([property: JsonPropertyName("code")] string? Code);
internal sealed record ApiStatsGame([property: JsonPropertyName("id")] int Id);
