...
{
    // Case: Create Snake Draft Order
    // Reasoning: This test verifies the Create Snake Draft Order operation.
    // Expected Result: The expected outcome is: Reverses Every Even Round.
    [Fact]
    ...
    // Case: Create Round Robin Fixtures
    // Reasoning: This test verifies the Create Round Robin Fixtures operation.
    // Expected Result: The expected outcome is: Creates Each Team Pair Once.
    [Theory]
    [InlineData(4, 6)]
    [InlineData(5, 10)]
    ...
    // Case: Create Round Robin Fixtures
    // Reasoning: This test verifies the Create Round Robin Fixtures operation.
    // Expected Result: The expected outcome is: Schedules Demo Rounds Every Five Minutes.
    [Fact]
