...
public sealed class UsersController(IUserService userService) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="request">The email address and password to verify.</param>
    /// <param name="cancellationToken">Token used to cancel the operation.</param>
    /// <returns>The authenticated user's profile.</returns>
    /// <response code="200">The credentials were verified successfully.</response>
    ...
    {
        return Ok(await userService.SignInAsync(request, cancellationToken));
    }
